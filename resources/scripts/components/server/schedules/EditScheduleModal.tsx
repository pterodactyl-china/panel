...
import ScheduleSimpleForm from '@/components/server/schedules/ScheduleSimpleForm';
                ...
                <Form>
                    ...
                    {simpleMode ? (
                        <ScheduleSimpleForm
                            ...
                            onChange={(v) => {
                                setFieldValue('minute', v.minute);
                                setFieldValue('hour', v.hour);
                                setFieldValue('dayOfMonth', v.dayOfMonth);
                                setFieldValue('month', v.month);
                                setFieldValue('dayOfWeek', v.dayOfWeek);
                            }}
                        />
                    ) : (
                        <>
